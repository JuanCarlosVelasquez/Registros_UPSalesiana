<?php
 if(isset($_POST["btnReporte"])){
	header("Location:index_excel_fechas.php"); }
?>
<html>
<head>
<title>Sistema de Registros UPS</title>
...
<table width="310" border="1" align="center" bordercolor="#000000" bgcolor="#FFFFFF">
<caption><font size=4 color="#FFFFFF">Escoja Fecha Y Hora:</font></caption>
<tr>
<td width="50%" bgcolor="#0088AD"><font color="#FFFFFF">Desde:</font><font color="#FFFFFF" size="2">[DD/MM/AAAA]</font></td>
<td width="50%"><input type="date" name="fecha1" maxlength="10"/></td>
</tr>
<tr>
<td width="50%" bgcolor="#0088AD"><font color="#FFFFFF">Hasta:</font><font color="#FFFFFF" size="2">[DD/MM/AAAA]</font></td>
<td width="50%"><input type="date" name="fecha2" maxlength="10"></td>
</tr>
<tr>
<td width="50%" bgcolor="#0088AD"><font color="#FFFFFF">Desde:</font><font color="#FFFFFF" size="2">[HH(24H):MM:SS]</font></td>
<td width="50%"><input type="time" name="hora1" maxlength="8"/></td>
</tr>
<tr>
<td width="50%" bgcolor="#0088AD"><font color="#FFFFFF">Hasta:</font><font color="#FFFFFF" size="2">[HH(24H):MM:SS]</font></td>
<td width="50%"><input type="time" name="hora2" maxlength="8"></td>
</tr>
<tr>
<td width="50%"><div align="center"><input type="submit" name="btnBuscar" id="btnBuscar" value="Buscar"/></div></td>
<td width="50%"><div align="center"><input type="submit" value="Excel" name="btnReporte" id="btnReporte"/></div></td>
</tr>
</table>
<br>
<br>
...
$sumser=$usu1->resumen_viservfec($fecha1, $fecha2, $hora1, $hora2);
$sumdia=$usu2->resumen_visitaspordiafec($fecha1, $fecha2, $hora1, $hora2);
$sumhor=$usu3->resumen_visitasporhorfec($fecha1, $fecha2, $hora1, $hora2);
...
<?php 
$lisUsu=$_usua->lista_AsistenciasAcumuladasFechas($fecha1, $fecha2, $hora1, $hora2);
