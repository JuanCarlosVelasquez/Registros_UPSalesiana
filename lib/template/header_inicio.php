	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="76" background="/Registro_UPS/lib/template/images/index_01.gif">
						<table width="100%" border="0" cellspacing="10" cellpadding="0">
							<tr>
								<td width="20%" align="center"><a href="/Registro_UPS/presentacion/index.php" class="green-text"><strong>Inicio</strong></a></td>
							...
							<tr>
								<td width="37%" align="center">
									<table width="195" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<img src="/Registro_UPS/lib/template/images/index_06.gif" width="195" height="26" alt="">
											</td>
										</tr>
										<tr>
											<td background="/Registro_UPS/lib/template/images/index_07.gif">
												<table width="100%" border="0" cellspacing="10" cellpadding="0">
													<tr>
														<td>
															<img src="/Registro_UPS/lib/template/images/index_09.gif" width="120" height="41" alt="">
														</td>
													</tr>
													<tr>
										...
										<tr>
											<td>
												<img src="/Registro_UPS/lib/template/images/index_12.gif" width="195" height="25" alt="">
											</td>
										</tr>
									</table>
								</td>
